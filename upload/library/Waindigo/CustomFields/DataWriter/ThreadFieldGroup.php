...
/**
* Data writer for thread field groups.
*/
class Waindigo_CustomFields_DataWriter_ThreadFieldGroup extends XenForo_DataWriter
{
    ...
    protected function _getExistingData($data)
    {
        ...
        return array(
            'xf_thread_field_group' => $this->_getFieldModel()->getThreadFieldGroupById($id)
        );
    }
    ...
    protected function _postSave()
    {
        ...
        $this->_getFieldModel()->rebuildThreadFieldCache();
    }
    ...
    protected function _postDelete()
    {
        ...
        $this->_db->update('xf_thread_field', array(
            'field_group_id' => 0
    ...
    {
        return $this->_getFieldModel()->getThreadFieldGroupTitlePhraseName($fieldGroupId);
    }

    /**
     *
     * @return XenForo_Model_ThreadField
     */
