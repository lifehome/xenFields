...
/**
* Data writer for social forum field groups.
*/
class Waindigo_CustomFields_DataWriter_SocialForumFieldGroup extends XenForo_DataWriter
{
    ...
    protected function _getExistingData($data)
    {
        ...
        return array(
            'xf_social_forum_field_group' => $this->_getFieldModel()->getSocialForumFieldGroupById($id)
        );
    }
    ...
    protected function _postSave()
    {
        ...
        $this->_getFieldModel()->rebuildSocialForumFieldCache();
    }
    ...
    protected function _postDelete()
    {
        ...
        $this->_db->update('xf_social_forum_field', array(
            'field_group_id' => 0
    ...
    {
        return $this->_getFieldModel()->getSocialForumFieldGroupTitlePhraseName($fieldGroupId);
    }

    /**
     *
     * @return XenForo_Model_SocialForumField
     */
