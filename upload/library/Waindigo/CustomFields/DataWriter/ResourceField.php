...
/**
 * Data writer for custom resource fields.
 */
class Waindigo_CustomFields_DataWriter_ResourceField extends Waindigo_CustomFields_DataWriter_AbstractField
{
     ...
     * field.
     *
     * @return Waindigo_CustomFields_Definition_ResourceField
     */
    public function getFieldDefinition()
    {
        return new Waindigo_CustomFields_Definition_ResourceField();
    }
    ...
    protected function _getExistingData($data)
    {
        ...
        return array(
            'xf_resource_field' => $this->_getFieldModel()->getResourceFieldById($id)
        );
    }
    ...
    protected function _postDelete()
    {
        ...
        // note the resource caches aren't rebuilt here; this shouldn't be an
