...
class Waindigo_CustomFields_ViewPublic_Helper_Resource
{
    ...
    /**
     * Add resource field HTML keys to the given list of fields.
     *
     ...
     *        not specified here
     */
    public static function addResourceFieldsValueHtml(XenForo_View $view, array $fields, array $values = array())
    {
        foreach ($fields as &$field) {
            $field['fieldValueHtml'] = self::getResourceFieldValueHtml($view, $field,
