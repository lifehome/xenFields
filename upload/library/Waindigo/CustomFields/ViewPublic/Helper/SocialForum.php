...
class Waindigo_CustomFields_ViewPublic_Helper_SocialForum
{

    /**
     * Gets the HTML value of the social forum field.
     *
     * @param array $field
     * @param mixed $value Value of the field; if null, pulls from field_value
     *        in field
     */
    public static function getSocialForumFieldValueHtml(XenForo_View $view, array $field, $value = null)
    {
        ...
        switch ($field['field_type']) {
            ...
            case 'select':
                $choice = $value;
                $value = new XenForo_Phrase("social_forum_field_$field[field_id]_choice_$value");
            ...
            case 'multiselect':
                ...
                foreach ($value as $id => $choice) {
                    $phrase = new XenForo_Phrase("social_forum_field_$field[field_id]_choice_$choice");
    ...
    /**
     * Add social forum field HTML keys to the given list of fields.
     *
     ...
     *        not specified here
     */
    public static function addSocialForumFieldsValueHtml(XenForo_View $view, array $fields, array $values = array())
    {
        foreach ($fields as &$field) {
            $field['fieldValueHtml'] = self::getSocialForumFieldValueHtml($view, $field,
